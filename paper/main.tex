...
With $\tilde c_1=c_1/b_1$ and $\tilde d_1=d_1/b_1$, the interior rows
$i=2,\ldots,N_\xi-1$ use
\begin{equation}
\label{eq:thomas-fwd}
  m_i = b_i-a_i\tilde c_{i-1},\quad
  \tilde c_i = \frac{c_i}{m_i},\quad
  \tilde d_i = \frac{d_i-a_i\tilde d_{i-1}}{m_i},
\end{equation}
and the final row closes the sweep with
$m_{N_\xi} = b_{N_\xi}-a_{N_\xi}\tilde c_{N_\xi-1}$ and
$\tilde d_{N_\xi} = (d_{N_\xi}-a_{N_\xi}\tilde d_{N_\xi-1})/m_{N_\xi}$.
